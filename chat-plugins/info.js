...
var commands = exports.commands = {
	...
	groups: function (target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox(
			"$ <b>Destacado</b> - Ellos pueden usar comandos con !<br />" +
			"+ <b>Vocero</b> - Ellos son capas de unirse a las batallas y hablar durante el chat moderado.<br />" +
			"\u2295 <b>Operador</b> - Pueden crear y gestionar torneos<br />" +
			"\u00A5 <b>Youtuber</b> - Puede advertir a los usuarios <br />" +
			"% <b>Conductor</b> - Lo anterior , y pueden silenciar . % Global también puede bloquear usuarios y comprobar si hay alts<br />" +
			"@ <b>Moderador</b> - Lo anterior , y pueden banear usuarios<br />" +
			"\u2605 <b>Jugador</b> - Rango especial sólo para las batallas . Se puede poner el modchat y dar promote a +<br />" +
			"&amp; <b>Lider</b> - Lo anterior ,  pueden promover al moderador, y forzar batallas.<br />" +
			"# <b>Dueño de sala</b> - Ellos son los líderes de la habitación y puede controlar casi en su totalidad la misma.<br />" +
			"~ <b>Administrador</b> - Pueden hacer cualquier cosa, como cambiar lo que dice este mensaje."
		);
	},
	groupshelp: ["/groups - Explica lo que + % @ # & ~ antes de los nombres de las personas significa.",
		"!groups - Muestra a todos la informacion Requieres: + % @ # & ~"],
	...
	roomhelp: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			"- /daymute OR /dm <em>username</em>: 24 horas de silencio<br />" +
